...
#ifndef SYSTEM_INC_SYSTEM_H_
#define SYSTEM_INC_SYSTEM_H_
...
//#                 SCI Defines                 #
//###############################################
#define     LSPCLK              37500000    //37.5MHz CLK

//###############################################
//#                 PWM Defines                 #
//###############################################
#define     FDSP                150000000UL   //150MHz DSP CLK
#define     FPWM                20000U       //20kHz PWM CLK
#define     CLKDIVISION         1
#define     HSPCLKDIVISION      2
//#define     PRD_VALUE           (FDSP / (2 * FPWM * CLKDIVISION * HSPCLKDIVISION))
#define     PRD_VALUE           3750
//
//CTRMODE bits
//
...
//#             External Variables              #
//###############################################
extern volatile Uint16 timer0_flag;
extern volatile Uint16 xInt3_flag;
...
//void DAC_Update(DAC_OutputData DAC_data);
//###############################################
//#             External Functions              #
//###############################################
...
static void ScibTx(unsigned char* str);

#endif /* SYSTEM_INC_SYSTEM_H_ */
